...
var SimpleGWCLIScript = class extends GWCLIScript {
  /**
  ...
  async _run() {
    ...
    const [success, response] = await this._runScript(scriptName, script, false);
    if (!response) {
...
var DynamicBalancingScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  /**
   ...
   */
  validateInputs(params) {
    if (params["param"] !== void 0 && params["param"] !== "") {
...
var VALID_PARAMS = ["-c", "-d", "-l", "-m", "-n", "-o", "-p", "-q", "-r", "-s", "-x"];
var FWAccelStatsScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
    this.optionalKeys = ["ipv6", "param"];
  }
  /**
   * Validate input values 
   */
...
var FWAccelStatScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
    this.optionalKeys = ["param"];
  }
  /**
   * Validate input values 
   */
...
var FWAccelConnsScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
  ...
  validateInputs(params) {
    const param = params["param"];
    if (param !== void 0 && param !== null && param.trim() !== "") {
      if (/[|&;><$`\\]/.test(param)) {
      ...
      while (i < tokens.length) {
        ...
        if (token === "-f") {
          if (i + 1 >= tokens.length || !new RegExp(`^[${allowedFilterFlags}]+$`).test(tokens[i + 1])) {
...
var HCPProtectInfoScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  /**
   ...
   */
  validateInputs(params) {
    if (params["param"] !== void 0 && params["param"] !== null && params["param"] !== "") {
...
var FWCtlScript = class extends SimpleGWCLIScript {
  static {
    this.optionalKeys = ["param"];
  }
  getScript() {
...
var FWCtlArpScript = class extends FWCtlScript {
  constructor() {
    super(...arguments);
    this.command = "arp";
  }
...
var FWCtlChainScript = class extends FWCtlScript {
  constructor() {
    super(...arguments);
    this.command = "chain";
  }
...
var FWCtlConnScript = class extends FWCtlScript {
  constructor() {
    super(...arguments);
    this.command = "conn";
  }
...
var FWCtlCPASStatScript = class extends FWCtlScript {
  constructor() {
    super(...arguments);
    this.command = "cpasstat";
  }
  /**
   * Validate input values 
   */
...
var FWCtlDLPKStatScript = class extends FWCtlScript {
  constructor() {
    super(...arguments);
    this.command = "dlpkstat";
  }
  /**
   * Validate input values 
   */
...
var FWCtlIfListScript = class extends FWCtlScript {
  constructor() {
    super(...arguments);
    this.command = "iflist";
  }
...
var FWCtlPStatScript = class extends FWCtlScript {
  constructor() {
    super(...arguments);
    this.command = "pstat";
  }
...
var FWCtlTCPStrStatScript = class extends FWCtlScript {
  constructor() {
    super(...arguments);
    this.command = "tcpstrstat";
  }
  static scriptNames() {
...
var DmidecodeScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  /**
...
var ShowAssetAllScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
...
var CPInfoAllScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
...
var ShowRouteScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
...
var NetstatRouteScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
...
var IPRouteShowScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
...
var CPHAProbStatScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  /**
...
var CPHAProbIfScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  /**
...
var CPHAProbSyncStatScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  /**
...
var CPLicPrintScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
...
var DiskUsageScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
...
var ShowVlanAllScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
   ...
   */
  validateInputs(params) {
    if (params["param"] !== void 0 && typeof params["param"] !== "string") {
...
var ShowInterfacesAllScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = [];
  }
  static {
...
var ShowInterfaceScript = class extends SimpleGWCLIScript {
  static {
    this.mandatoryKeys = ["interface_name"];
  }
  static {
    this.optionalKeys = [];
  }
...
server.tool(
  ...
  {
    target_gateway: import_zod.z.string().describe("The target gateway to run the command on"),
    interface_name: import_zod.z.string().optional().describe("Optional parameter for the show vlan command")
  },
...
server.tool(
  ...
  {
    target_gateway: import_zod.z.string().describe("The target gateway to run the command on"),
    ipv6: import_zod.z.boolean().optional().describe("Optional parameter to show IPv6 statistics"),
    param: import_zod.z.string().optional().describe("Optional parameter for the fwaccel stats command")
  },
...
server.tool(
  ...
  {
    target_gateway: import_zod.z.string().describe("The target gateway to run the command on"),
    ipv6: import_zod.z.boolean().optional().describe("Optional parameter to show IPv6 connections"),
    param: import_zod.z.string().optional().describe("Optional parameter for the fwaccel conns command")
  },
  async ({ target_gateway, ipv6, param }, extra) => {
    const result = await runScript(
      server,
...
server.tool(
  ...
  {
    target_gateway: import_zod.z.string().describe("The target gateway to run the command on"),
    param: import_zod.z.string().optional().describe("Optional parameter for the fw ctl pstat command")
  },
...
server.tool(
  ...
  {
    target_gateway: import_zod.z.string().describe("The target gateway to run the command on"),
    param: import_zod.z.string().optional().describe("Optional parameter for the fw ctl tcpstrstat command")
  },
  async ({ target_gateway, param }, extra) => {
    const result = await runScript(
      server,

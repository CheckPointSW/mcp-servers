...
// packages/https-inspection/dist/index.js
var index_exports = {};
...
server.tool(
  ...
  "Retrieve an existing HTTPS Inspection rule using either the rule number or the unique identifier (UID) of the rule. It also allows you to specify the level of detail for the fields in the response, ranging from just the UID value to a fully detailed representation of the rule.",
  {
    ...
    details_level: import_zod.z.string().optional().default("standard")
  },
  async (args, extra) => {
    const uid = typeof args.uid === "string" ? args.uid : void 0;
    const rule_number = typeof args.rule_number === "string" ? args.rule_number : void 0;
    const layer = typeof args.layer === "string" ? args.layer : void 0;
...
server.tool(
  ...
  "Retrieve the entire HTTPS Inspection Rules layer. It can filter the rules based on search criteria and provides a list of objects. The function allows you to set filter preferences, limit the number of results, and sort the results.",
  {
    ...
    order: import_zod.z.array(import_zod.z.object({ ASC: import_zod.z.string().optional(), DESC: import_zod.z.string().optional() })).optional(),
  ...
  async (args, extra) => {
    ...
    const filter = typeof args.filter === "string" ? args.filter : void 0;
    const limit = typeof args.limit === "number" ? args.limit : 50;
    const offset = typeof args.offset === "number" ? args.offset : 0;
    const order = Array.isArray(args.order) ? args.order : void 0;
    const package_name = typeof args.package === "string" ? args.package : void 0;
    const details_level = typeof args.details_level === "string" ? args.details_level : "standard";
    const use_object_dictionary = typeof args.use_object_dictionary === "boolean" ? args.use_object_dictionary : void 0;
    const dereference_group_members = typeof args.dereference_group_members === "boolean" ? args.dereference_group_members : void 0;
    const show_membership = typeof args.show_membership === "boolean" ? args.show_membership : void 0;
    ...
    params["details-level"] = details_level;
    if (use_object_dictionary !== void 0) params["use-object-dictionary"] = use_object_dictionary;
    if (dereference_group_members !== void 0) params["dereference-group-members"] = dereference_group_members;
    if (show_membership !== void 0) params["show-membership"] = show_membership;

...
1. Download the MCPB file: **[📥 management.mcpb](https://github.com/CheckPointSW/mcp-servers/releases/latest/download/management.mcpb)**
...
```bash
MCP_TRANSPORT_TYPE=http MCP_TRANSPORT_PORT=3000 npx @chkp/quantum-management-mcp
# or
npx @chkp/quantum-management-mcp --transport http --transport-port 3000
```
